del "%OSGEO4W_STARTMENU%\QGIS Desktop @version@ (Qt6).lnk"
del "%OSGEO4W_STARTMENU%\Qt Designer with QGIS @version@ custom widgets (Qt6).lnk"
rmdir "%OSGEO4W_STARTMENU%"
del "%OSGEO4W_DESKTOP%\QGIS Desktop @version@ (Qt6).lnk"
del "%OSGEO4W_DESKTOP%\Qt Designer with QGIS @version@ custom widgets (Qt6).lnk"
