del "%OSGEO4W_STARTMENU%\QGIS Desktop @version@ (@appname@).lnk"
del "%OSGEO4W_STARTMENU%\Qt Designer with QGIS @version@ custom widgets (@appname@).lnk"
rmdir "%OSGEO4W_STARTMENU%"
del "%OSGEO4W_DESKTOP%\QGIS Desktop @version@ (@appname@).lnk"
del "%OSGEO4W_DESKTOP%\Qt Designer with QGIS @version@ custom widgets (@appname@).lnk"
